...
export const AboutSection = () => {
  return (
    <section id="about" className="relative px-4 py-16 md:py-24 overflow-hidden z-10">
      ...
      >
        <div className="text-[16px] sm:text-[18px] md:text-[20px] lg:text-[22px] leading-[1.8] sm:leading-relaxed md:leading-8 lg:leading-9 text-slate-800 dark:text-neutral-200 font-sans font-medium space-y-6 text-left sm:text-center px-2 sm:px-0">
          ...
          <div className="p-4 mb-6 rounded-2xl bg-gradient-to-r from-purple-100/50 to-pink-100/50 dark:from-purple-900/20 dark:to-pink-900/20 border border-purple-200/50 dark:border-purple-800/30">
            <p className="text-lg sm:text-xl md:text-2xl font-bold bg-gradient-to-r from-purple-600 to-pink-500 dark:from-purple-400 dark:to-pink-400 bg-clip-text text-transparent">
          ...
          <p>
            I have a strong interest in client servicing, media coordination, and community engagement, with experience collaborating across teams, coordinating campaigns, managing online communities, and fostering meaningful interactions that strengthen brand relationships and support business objectives.
          </p>

          <p>
            My ability to balance creativity with analytical thinking enables me to develop and execute marketing initiatives that align with both brand and business goals.
          </p>

          <p>
            Before transitioning into marketing, I built a strong foundation through three years of experience in Software Development, Testing, and Quality Assurance, developing expertise in analytical thinking, problem-solving, process optimisation, and quality management.
          </p>

          <p>
            This unique blend of technical proficiency and creative marketing acumen enables me to bridge business, creative, and technical teams while delivering strategic, results-oriented solutions that align technology with business and customer objectives.
          </p>
