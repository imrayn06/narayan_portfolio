        ...
        <div className="space-y-12">
          {experiences.map((exp, index) => (
            <motion.div
              ...
              className="bg-white dark:bg-slate-800/60 rounded-3xl p-8 md:p-10 shadow-lg border border-slate-200 dark:border-slate-700/50"
            >
              <div className="flex flex-col md:flex-row md:items-center justify-between mb-8 border-b border-slate-200 dark:border-slate-700 pb-6">
                <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div className="space-y-6">
                  <div>
                    <h4 className="text-lg font-bold text-slate-800 dark:text-gray-200 mb-2 flex items-center">
